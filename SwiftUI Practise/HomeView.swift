...
let sectionData = [
    ...
    Section(title: "Build a SwiftUI App", text: "19 Sections", logo: "Logo2", image: Image("Card2"), color: Color("card2")),
    Section(title: "SwiftUI is the coolest", text: "12 Sections", logo: "Logo3", image: Image("Card3"), color: Color("card3")),
    Section(title: "Prototype SwiftUI", text: "1 Sections", logo: "Logo3", image: Image("Card4"), color: Color.black)
]
